...
from plan.carFollowingModel import PATH_CACC, Path_ACC, SUMO_CACC_Controller, Plexe_CACC_Controller,HInfinityController, Adaptive_CACCController, PFL_CACC, IDM, SUMO_CACC_Model, PloegModel, CACC_Sample_Model
import carla
import time
...
class CACCPlanner(BasePlanner):
    ...
    def change_speed_profile(self, time_interval=200, low_speed=15, high_speed=20):
